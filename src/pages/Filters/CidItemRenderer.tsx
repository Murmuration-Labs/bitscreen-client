...
export default class CidItemRender extends React.Component<CidItemProps, {item: CidItem}> {
    ...
    updateItemField(field: string, value: any, item: CidItem): CidItem{
        if (field === "cid") {
            item.cid = value;
        }
        return item;
                            ...
                            <Card.Body>
                                <div className='k-hbox k-justify-content-between k-flex-wrap'>
                                    <div style={{ width: '65%', padding: '5 0' }}>
                                        ...
                                        <input value={this.state.item.cid} onChange={
                                            (e: ChangeEvent<HTMLInputElement>) => this.handleChange(e, 'cid')} />
                                    </div>
