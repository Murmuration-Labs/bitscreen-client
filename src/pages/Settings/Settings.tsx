        ...
        <Row className={"settings-block"} style={{ marginTop: 25 }}>
          <Col>
            ...
            <p className="text-dim">
              ...
              requires adding country information, which is used for statistical
              purposes.
            </p>
          </Col>
        </Row>
        ...
        <Row className={"settings-block"}>
          <Col>
            ...
            <p className="text-dim">
              ...
              requires adding list provider data, which is made public to other
              users when you share lists.
            </p>
          </Col>
        </Row>
      )}
