...
import { activeIcon } from "../../resources/icons";
...
export default function Settings(props) {
  const { setProvider, setConfig } = props;
  ...
  const hasUnfilledInfo = () => {
    if ((configInfo.share || configInfo.bitscreen) && !providerInfo.country) {
      return true;
    }
          ...
          <div aria-describedby="options-section" className="section options">
            ...
            >
              ...
              <div className="slice-guide t-ls">
                Please add country data (required for imports).
              </div>
            ...
            >
              ...
              <div className="slice-guide t-ls">
                Please add list provider information (required for sharing and
                made public in Directory).
              </div>
              <div className="slice-input">
